...
echo ""
echo "sampling=5%, num-executors=16"
echo "-------------------------------------------------------"
spark-submit \
  --master yarn \
  --packages ch.cern.sparkmeasure:spark-measure_2.12:0.27 \
...
echo ""
echo "sampling=5%, num-executors=12"
echo "-------------------------------------------------------"
spark-submit \
  --master yarn \
  --packages ch.cern.sparkmeasure:spark-measure_2.12:0.27 \
...
echo ""
echo "3: sampling=5%, num-executors=8"
echo "-------------------------------------------------------"
spark-submit \
  --master yarn \
  --packages ch.cern.sparkmeasure:spark-measure_2.12:0.27 \
...
echo "================================"
aws s3 cp /home/efs/erasmus/emanuel/metrics s3://ubs-homes/erasmus/emanuel/metrics5 --recursive
